...
const copy: Record<Locale, Record<PageKey, { title: string; description: string }>> = {
  en: {
    ...
    platforms: { title: "Platforms", description: "The five public-facing EBOVIR platforms — EboGenes, EboScience, EboMed AI, EBOVIR Medical IT, and EBOVIR Lab — spanning genetic health, exosome biotechnology, AI healthcare, medical IT, and laboratory services." },
  ...
  fr: {
    ...
    platforms: { title: "Plateformes", description: "Les cinq plateformes publiques d’EBOVIR — EboGenes, EboScience, EboMed AI, EBOVIR Medical IT et EBOVIR Lab — couvrent la santé génétique, les exosomes, l’IA en santé, les TI médicales et les services de laboratoire." },
  ...
  "zh-CN": {
    ...
    platforms: { title: "平台", description: "EBOVIR 的五个对外平台 EboGenes、EboScience、EboMed AI、EBOVIR Medical IT 和 EBOVIR Lab，覆盖遗传健康、外泌体生物技术、人工智能医疗、医疗信息化和实验室服务。" },
